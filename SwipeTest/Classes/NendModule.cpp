...
extern "C"
{
	JNIEXPORT void JNICALL Java_net_nend_NendModule_NendModule_onReceiveAd(JNIEnv* env, jobject thiz) {
	    //ロード終了のオブザーバー通知
	    CCNotificationCenter::sharedNotificationCenter()->postNotification("NEND_NOTIFICATION_RECEIVE_AD", NULL);
	}

	JNIEXPORT void JNICALL Java_net_nend_NendModule_NendModule_onFailedToReceiveAd(JNIEnv* env, jobject thiz) {
	    //ロード失敗のオブザーバー通知
	    CCNotificationCenter::sharedNotificationCenter()->postNotification("NEND_NOTIFICATION_FAIL_TO_RECEIVE_AD", NULL);
	}
	...
	JNIEXPORT void JNICALL Java_net_nend_NendModule_NendModule_onClick(JNIEnv* env, jobject thiz) {
	    //広告クリックのオブザーバー通知
	    CCNotificationCenter::sharedNotificationCenter()->postNotification("NEND_NOTIFICATION_CLICK_AD", NULL);
	}
}
